...
const handleFileChange = (
  ...
  const data: {} = {
    event: event,
    filename: filename,
    shouldReload: maybeData && maybeData.error ? false : true,
    ...maybeData
  };
...
const typescriptCompiler = startTypescriptCompiler(handleFileChange);

// If the typescript error flagged -- emit an error event instead...
